...
CONFIG=${PROJECT_ROOT}/configs/yajiang_v1_2_continue_100.yaml
MANIFEST=${PROJECT_ROOT}/data/full_npy/train.jsonl
RESUME=${RESUME:-${PROJECT_ROOT}/outputs/aef_hyh_yajiang_v1_2/checkpoints/best.pt}
...
DEVICE=${DEVICE:-auto}
SPLIT=${SPLIT:-train}
OUTPUT_DIR="outputs/aef_hyh_yajiang_v1_2_continue_100"
...
echo "Continuing v1.2 to 100 epochs on CUDA GPU(s) ${CUDA_VISIBLE_DEVICES}"
echo "Config: ${CONFIG}"
