...
CONFIG=${PROJECT_ROOT}/configs/yajiang_v1_2_continue_200.yaml
MANIFEST=${PROJECT_ROOT}/data/full_npy/train.jsonl
RESUME=${RESUME:-${PROJECT_ROOT}/outputs/aef_hyh_yajiang_v1_2_continue_100/checkpoints/best.pt}
...
echo "Continuing v1.2 to 200 epochs on CUDA GPU(s) ${CUDA_VISIBLE_DEVICES}"
echo "Config: ${CONFIG}"
