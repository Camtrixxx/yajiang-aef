...
python scripts/evaluate_model_suite.py \
  --config configs/yajiang_v1_3_continue_200.yaml \
  --manifest data/full_npy/train.jsonl \
  --deploy-model outputs/aef_hyh_yajiang_v1_3_continue_200/exports/aef_hyh_yajiang_v1_3_continue_200_deploy.pt \
  --output-dir outputs/model_eval/v1_3_continue_200 \
  --device auto \
